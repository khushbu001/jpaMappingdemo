package com.example.jpa.jparelationshipdemo.controller;
...
import com.example.jpa.jparelationshipdemo.service.EmployeeService;
...
public class EmployeeController {
	...
	// @ApiOperation("This API will use to create the employee entity")
	/*
	 * @PostMapping(value = "/employeeDept") public ResponseEntity<Object>
	 * createEmployeeDept(@RequestBody EmpDept empdept) {
	 * 
